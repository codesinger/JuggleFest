#ifndef circuit_set_iterator_h_included
#define circuit_set_iterator_h_included 1

/*!
 * \file circuit_set_iterator.h
 *
 * \brief Contains the definition of circuit_set_iterator
 *
...
/*!
 * \brief An iterator over circuit_set
 */
class circuit_set_iterator : public type_pointer_set_iterator<std::string, circuit *>
{
public:
   ...
   */
  explicit circuit_set_iterator(
    circuit_set     &cs)
  :
  type_pointer_set_iterator<std::string, circuit *>(cs)
  { }
  ...
  friend std::ostream &operator<<(
    ...
    const circuit_set_iterator  &cn)/*!< The object to be streamed          */
  {
...
private:
   ...
   */
  circuit_set_iterator(
    const circuit_set_iterator   &rhs);
...
#endif                             /* circuit_set_iterator_h_included       */
